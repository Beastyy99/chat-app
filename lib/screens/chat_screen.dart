      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData) {
          ...
          for (var message in messages) {
            Map<String, dynamic> messageText =
                message.data() as Map<String, dynamic>;
            Map<String, dynamic> messageSender =
                message.data() as Map<String, dynamic>;
            final texts = messageText['text'];
            final senders = messageSender['sender'];

            final currentUser = loggedInUser.email;

            final messageBubble = MessageBubble(
                sender: senders, text: texts, isMe: currentUser == senders);
